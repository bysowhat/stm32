...
void data_transition(void)
{
	...
	Send_Data.Sensor_Str.X_speed = ((MOTOR_A.Encoder_metre+MOTOR_B.Encoder_metre)/2)*1000; //小车x轴速度
	Send_Data.Sensor_Str.Y_speed = 0;
	Send_Data.Sensor_Str.Z_speed = ((MOTOR_B.Encoder_metre-MOTOR_A.Encoder_metre)/Wheel_spacing)*1000;//小车z轴速度
...
{	
	...
	{	      
		...
		if(Usart_Receive==0x41) Flag_Stop=0;
		//if(Usart_Receive==0x61) Flag_Stop=!Flag_Stop;
		if(Usart_Receive==0x62) Flag_Stop=!Flag_Stop;
		//if(Usart_Receive==0x63) Flag_Stop=!Flag_Stop;
	 ...
	 if(Flag_PID==2) //Analyze the data //分析数据
	 {
		  ...
		  else  if(Receive[3]==0x57) Flash_Write();
				...
				switch(Receive[1])
				 {
					 ...
					 case 0x31:  Balance_Kp           =Data/100; break;
					 case 0x32:  Balance_Kd           =Data/100; break;
					 case 0x33:  Balance_V_KP         =Data/100; break;
					 case 0x34:  Balance_V_KI         =Data/100; break;
					 case 0x35:  Encoder_Integral_Max =Data;     break;
					 //case 0x36:  Angle_Zero           =Data-1000;break;
				 }
      }		
