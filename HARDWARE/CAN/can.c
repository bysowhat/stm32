...
int CAN_ERROR=0, CAN_ERROR_TIMES=0;
int Encoder_count=0;
void USB_LP_CAN1_RX0_IRQHandler(void)
{
	...
	if(temp_rxbuf[0]==0x80)CAN_ERROR=1, CAN_ERROR_TIMES++;
	if(id==0x181)
	{
		Encoder_count++;
	...
	//	Left_encoder_rpm =temp_rxbuf[1]*256+temp_rxbuf[0];
	//	Right_encoder_rpm=temp_rxbuf[3]*256+temp_rxbuf[2];
	}
}
#endif
/**************************************************************************
